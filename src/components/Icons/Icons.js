...
export const HomeIconRegular = ({ width = '3.2rem', height = '3.2rem', className }) => (
    <svg
        width={width}
        data-e2e=""
        height={height}
...
export const UserGroupIconRegular = ({ width = '3.2rem', height = '3.2rem', className }) => {
    <svg
        width={width}
        data-e2e=""
        height={height}
...
export const ExploreIconRegular = ({ width = '3.2rem', height = '3.2rem', className }) => (
    <svg fill="currentColor" width={width} height={height} viewBox="0 0 48 48" xmlns="http://www.w3.org/2000/svg">
        <path
            fillRule="evenodd"
            clipRule="evenodd"
...
export const LiveIconRegular = ({ width = '3.2rem', height = '3.2rem', className }) => (
    <svg
        width={width}
        data-e2e=""
        height={height}
...
export const HomeIconSolid = ({ width = '3.2rem', height = '3.2rem', className }) => (
    <svg
        width={width}
        data-e2e=""
        height={height}
...
export const UserGroupIconSolid = ({ width = '3.2rem', height = '3.2rem', className }) => (
    <svg
        width={width}
        data-e2e=""
        height={height}
...
export const ExploreIconSolid = ({ width = '3.2rem', height = '3.2rem', className }) => (
    <svg
        fill="rgba(254, 44, 85, 1)"
        width={width}
        height={height}
...
export const LiveIconSolid = ({ width = '3.2rem', height = '3.2rem', className }) => (
    <svg
        width={width}
        data-e2e=""
        height={height}
